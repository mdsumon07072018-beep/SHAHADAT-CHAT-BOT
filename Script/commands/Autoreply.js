...
module.exports.handleEvent = async function ({ api, event, Users }) {
  ...
  const responses = {
    "miss you": "অরেক বেডারে Miss না করে xan মেয়ে হলে বস শাহরিয়ার সুমন  রে হাঙ্গা করো😶👻😘",
    ...
    "khan shaheb": "উনি এখন কাজে বিজি আছে কি বলবেন আমাকে বলতে পারেন..!😘",
    "owner": "‎[𝐎𝐖𝐍𝐄𝐑:☞ khan shaheb☜\nFacebook:https://www.facebook.com/balanc1334 \nWhatsApp: +9660542641713",
    "admin": "He is Khan Shaheb  তাকে সবাই Cyber Bot Team Saport Admin হিসেবে চিনে😘☺️",
    ...
    "fork": "https://github.com/sumon-sahu/Khan-CHAT-BOT.git",
    ...
    "ami khan shaheb": "হ্যা বস কেমন আছেন..?☺️",
    "bot er baccha": "আমার বাচ্চা তো তোমার গার্লফ্রেন্ডের পেটে..!!🌚⛏️",
    "tor nam ki": "MY NAME IS ─꯭─⃝‌‌𝐒𝐡ariar sumon 𝐂𝐡𝐚𝐭 𝐁𝐨𝐭💖",
    ...
    "love you": "ভালোবাসা নামক আবলামী করতে চাইলে Boss খান শাহেব মানে বস সুমন এর ইনবক্সে গুতা দিন 😘",
